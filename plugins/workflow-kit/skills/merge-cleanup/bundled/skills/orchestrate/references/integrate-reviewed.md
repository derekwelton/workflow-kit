...
head. Apply `../../../templates/merge-completion.md` for merge verification and
...
Follow `../../../templates/cleanup-owned.md` for authorized cleanup, limited to
...
Return the updated usage/testing guide from `../../../templates/completion-guide.md`.
