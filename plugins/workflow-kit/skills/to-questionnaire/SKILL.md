...
Reuse recipient and outcome details already supplied. Respect a requested output location; otherwise use the filename above. Mark unknown deadlines as unspecified. Creating the questionnaire does not authorize sending it.
