...
MIT, Copyright (c) 2026 DietrichGebert.
...
These imports use the same MIT license. `grill-me` reuses the bundled
...
as requested; added Codex metadata allows implicit invocation.
...
references and executable helpers. Canonical files remain in
