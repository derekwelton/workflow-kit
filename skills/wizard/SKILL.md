...
- Tell the user how to run it, including the Bash prerequisite on Windows. If
  it's a repeatable setup path, link it from the README and commit only when
  authorized. Keep secrets out of transcripts and generated source code.
